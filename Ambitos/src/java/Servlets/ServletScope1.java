 ...
 * @author JuanJesus
 */
@WebServlet(name = "ServletScope1", urlPatterns = {"/ServletScope1"})
public class ServletScope1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            scopeSession.setAttribute("atributoSession", "Prueba de atributos en sesión");
            
            //Scope aplication
            ServletContext scopeApplication = this.getServletContext();
            scopeApplication.setAttribute("atributoAplicacion", "Prueba de atributos en aplicación");
