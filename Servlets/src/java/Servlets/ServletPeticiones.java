 ...
 * @author isaa
 */
@WebServlet(name = "ServletPeticiones", urlPatterns = {"/ServletPeticiones"})
public class ServletPeticiones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletPeticiones</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("Las variables enviadas son: <br>");
