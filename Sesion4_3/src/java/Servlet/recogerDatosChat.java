...
import Entidades.datosPantallaBean;
...
public class recogerDatosChat extends HttpServlet {
    ...
    datosPantallaBean datos = new datosPantallaBean();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!request.getParameter("texto").isEmpty()){
            datos.addTexto((String) request.getSession().getAttribute("nick"), request.getParameter("texto"));
        }
        } catch (Exception e){
            
        }
        
        request.setAttribute("chat", datos);
